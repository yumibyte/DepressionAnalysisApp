...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 25 13:28:21 2020
...
# Reproducibility
np.random.seed(1234)
DEPRES_NROWS = 3907  # number of rows to read from DEPRESSIVE_TWEETS_CSV
RANDOM_NROWS = 26616 # number of rows to read from RANDOM_TWEETS_CSV
...
BufferErrordata_d = pad_sequences(sequences_d, maxlen=MAX_SEQUENCE_LENGTH)
...
model.save('DepressionNLPModelFinal.h5')

your_model = coremltools.converters.keras.convert('DepressionNLPModelFinal.h5', input_names=['text'], output_names=['output'])

your_model.save('DepressionNLPModelFinal.mlmodel')
"""
class LogReg:
    """
